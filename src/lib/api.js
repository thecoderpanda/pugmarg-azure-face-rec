...
const config = {
	API_URL: 'https://pugmarfacerec.cognitiveservices.azure.com/face/v1.0/',
	pugmarg_side_url: 'http://pugmarg.in/pugmargEmsTest/public/api/addPersonId'
};
...
const postpugmarg = ({ path, ...rest }) =>
	apiFetchPug({
		url: config.pugmarg_side_url,
		method: 'POST',
		...rest
	});
const put = ({ path, ...rest }) =>
...
export const createaddperson = (personId, name) =>
   postpugmarg({
